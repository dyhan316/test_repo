...
sub_save_dir=/scratch/08834/tg881334/2019/test/test_NO_DENOISE_NO_distortion_2
...
singularity run --cleanenv -B ${data_pth}/:/data:ro,${sub_save_dir}/:/out,${supp_dir}:/freesurfer,${fs_dir}:/fs_input,${recon_input}:/recon_input\
 ...
 --recon-spec mrtrix_multishell_msmt_ACT-hsvs --omp-nthreads 100\
 --denoise-method none --dwi-no-biascorr --ignore fieldmaps
#--recon-only --recon-input /recon_input --dwi-only
